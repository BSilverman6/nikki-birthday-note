...
function gameController(){
    ...
    const players = [
        {name: p1Name === ""? "Fire Nikki": p1Name, marker: p1Marker},
        {name: p2Name === ""? "Water Nikki": p2Name, marker: p2Marker}
    ]
    ...
    const createScreen = () =>{
        ...
        board.forEach((cell, index) =>{
            ...
            if (cell.getValue() !== "X" &&cell.getValue() !== "O" && cell.getValue() !== null){
                ...
                if (cell.getValue() === "water-nikki" ){
                    image.classList.add("nikki-water");
                }
                if (cell.getValue() === "fire-nikki"){
                    image.classList.add("nikki-fire");
                }
